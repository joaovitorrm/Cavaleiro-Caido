...
| ------------------------------------------------ | --------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------- |
| Não abre corretamente em browsers não "google" | `<ul><li>`[x] resolvido `</li><li>`[ ] não será resolvido `</li><li>`[ ] em resolução `</li>` | nested CSS muito recente, funcionalidade prototipada pelo chrome |
| Exemplo 2                                        | [ ]                                                                                                       | exemplo                                                          |
| Exemplo 3                                        | [ ]                                                                                                       | exemplo                                                          |
| Exemplo 4                                        | [ ]                                                                                                       | exemplo                                                          |
